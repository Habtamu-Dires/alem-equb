...
export class RegistrationService extends BaseService {
   ...
   */
  register$Response(params?: Register$Params, context?: HttpContext): Observable<StrictHttpResponse<IdResponse>> {
   ...
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  register(params?: Register$Params, context?: HttpContext): Observable<IdResponse> {
